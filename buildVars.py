...
So, the document type "Only paper orientation" only announce the orientation of the image.
 ...
 Some bugs were corrected."""),
	...
	addon_url = "https://github.com/ruifontes/tesseractOCR",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL = "https://github.com/ruifontes/tesseractOCR",
...
pythonSources: list[str] = ["addon/globalPlugins/tesseractOCR/*.py", "addon/*.py"]
